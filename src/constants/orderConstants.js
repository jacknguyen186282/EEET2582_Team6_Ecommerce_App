...
export const ORDER_HISTORY_USER_REQUEST = 'ORDER_HISTORY_USER_REQUEST';
export const ORDER_HISTORY_USER_SUCCESS = 'ORDER_HISTORY_USER_SUCCESS';
export const ORDER_HISTORY_USER_FAIL = 'ORDER_HISTORY_USER_FAIL';
